...
@section('content')
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1>Create</h1>
            <form id="inputForm" method="post" action="{{route('post.update',$post->id)}}" enctype="multipart/form-data">
              @csrf
              @method('PATCH')
              ...
              <div class="form-group">
                  ...
                  @php
                            ...
                            @endphp
                                <img style="height: 100px;" src='{{$post->image}}' alt='' srcset=''>;
                            @php
                            }else{
                            @endphp

                                <img style="height: 100px;" src='{{asset("storage/". $post->image)}}' alt='' srcset=''>;
                            @php
                        }
                        @endphp
                ...
                <div class="form-group">
                    ...
                    <div>
                      ...
                      <input type="text" hidden name="body" id="inputbody" value="{{$post->body}}">
